...
,QAUX5_ERR , DOUBLE_ERR , REMOVE_ERR, GLL_ERR
             }Erreurs;
...
switch   (sym_cour.code) {
                case GLL_TOKEN :   sym_suiv();if(liste_membres!=NULL)strcat(liste_membres,sym_cour.nom);Test_Symbole(STRING_TOKEN,STRING_ERR);
