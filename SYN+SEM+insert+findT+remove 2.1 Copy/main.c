...
interpreter_update(chemin,quxx,ER,liste_membres);
}
...
strcat(collection,".txt");
            switch (sym_cour.code){
                  ...
                  case CREATECOLLECTION_TOKEN : sym_suiv();Test_Symbole(PARO_TOKEN,PARO_ERR);Test_Symbole(GLL_TOKEN,GLL_ERR);strcpy(arg,sym_cour.nom);
                  Test_Symbole(STRING_TOKEN,STRING_ERR);Test_Symbole(GLL_TOKEN,GLL_ERR);break;
